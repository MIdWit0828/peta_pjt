...
(
    `auth_member_code`    INT NOT NULL AUTO_INCREMENT COMMENT '권한-맴버 코드',
    `auth_code`    INT NOT NULL COMMENT '권한 코드',
...
(
    `auth_code`    INT NOT NULL AUTO_INCREMENT COMMENT '권한 코드',
...
(
    `data_code`    INT NOT NULL AUTO_INCREMENT COMMENT '자료 코드',
    ...
    `member_code`    INT NOT NULL COMMENT '등록자 코드',
    `is_delete`    BOOLEAN NOT NULL COMMENT '삭제여부',
    `access_level_code`    INT NOT NULL COMMENT '자료 접근 수준 코드',
    `data_category_code`    INT NOT NULL COMMENT '자료 구분 코드',
...
(
    `access_level_code`    INT NOT NULL AUTO_INCREMENT COMMENT '자료 접근 수준 코드',
...
(
    `data_category_code`    INT NOT NULL AUTO_INCREMENT COMMENT '자료 구분 코드',
...
(
    `member_code`    INT NOT NULL AUTO_INCREMENT COMMENT '맴버 코드',
    `member_id`    VARCHAR(100) NOT NULL COMMENT '맴버 아이디',
    `member_pwd`    VARCHAR(100) NOT NULL COMMENT '맴버 비밀번호',
    `member_name` VARCHAR(255) NOT NULL COMMENT '맴버 이름',
    `email`    VARCHAR(100) COMMENT '이메일',
    `phone`    VARCHAR(50) COMMENT '연락처',
    `attachment_code`    INT COMMENT '명함사진 코드',
